export const currencies = [
  { code: 'INR', symbol: '₹', name: 'Indian Rupee', region: 'India', accent: '#6b2148', rateFromInr: 1 },
  ...
  { code: 'ZAR', symbol: 'R', name: 'Rand', region: 'South Africa', accent: '#a86b2d', rateFromInr: 0.22 },
]
